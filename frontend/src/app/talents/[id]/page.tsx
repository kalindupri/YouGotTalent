...
import { Bookmark, Check, Crown, FileText, Play, Share2, ShieldCheck, Star } from "lucide-react";
import { ApiError, Credit, Media, TalentProfile, TalentReviewSummary, api } from "@/lib/api";
import {
    ...
    >
      ...
      <div>
        <p className="text-sm font-semibold text-zinc-900 dark:text-zinc-50">
          {media.title ?? (media.media_type === "video" ? "Watch video" : "View document")}
        </p>
